...
public class ConductorRequiemItem extends SwordItem implements QAModWeapon {
    ...
    public ConductorRequiemItem(Tier tier, float attackDamage, float attackSpeed, Properties properties) {
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity livingEntity, int timeCharged) {
        ...
        int timeUsed = this.getUseDuration(stack, player) - timeCharged;
